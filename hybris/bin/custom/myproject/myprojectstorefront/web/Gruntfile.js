module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      less: {
        files: [
          "webroot/WEB-INF/_ui-src/shared/less/variableMapping.less",
      ...
      ybasejs: {
        files: [
          "webroot/WEB-INF/_ui-src/responsive/lib/ybase-0.1.0/js/**/*.js",
        ],
        ...
        files: [
          {
            ...
            rename: function (dest, src) {
              var nsrc = src.replace(
                new RegExp("/themes/(.*)/less"),
                "/theme-$1/css"
              )
              return dest + nsrc
            },
